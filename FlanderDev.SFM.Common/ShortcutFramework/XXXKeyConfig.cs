...
/// </summary>
public readonly struct XXXKeyConfig(KeyCode mainKey, params KeyCode[] modifiers) : IEquatable<XXXKeyConfig>
{
    public static readonly XXXKeyConfig Empty = new(KeyCode.None);
    ...
    /// </summary>
    public static bool TryParse(string s, out XXXKeyConfig result)
    {
        result = Empty;
        ...
        result = new XXXKeyConfig(codes[^1], codes[..^1]);
        return true;
    }
    ...
    #region Equality
    public bool Equals(XXXKeyConfig other) =>
        MainKey == other.MainKey &&
        new HashSet<KeyCode>(Modifiers).SetEquals(other.Modifiers);

    public override bool Equals(object? obj) => obj is XXXKeyConfig k && Equals(k);
    ...
    public static bool operator ==(XXXKeyConfig a, XXXKeyConfig b) => a.Equals(b);
    public static bool operator !=(XXXKeyConfig a, XXXKeyConfig b) => !a.Equals(b);
    #endregion
}
